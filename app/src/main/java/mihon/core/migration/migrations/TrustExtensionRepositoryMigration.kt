...
/**
 * Mihon Kids: upstream imports every URL from the legacy `extension_repos` preference straight into
 ...
 *
 * Stores are added only through AddExtensionStore, which enforces mihon.kids.KidsPolicy.
 */
@Inject
